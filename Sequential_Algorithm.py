...
print("walk straight on Spence st. till you reach  Liberal Arts and Humanities Building")
...
print("walk until you reach the Department of Biology")
print("turn Left onto Nagle Street")
print("Walk until you reach an intersection")
...
print("Once you reach the Starbucks, take the half flight of stars down to the first floor where you will find the atrium.")
print("Once at the atrium, take a left to the main exit and onto Spence Street.")
print("Take a right onto Ross Street.")
print("Continue on Ross Street, and you will see that it will slowly take a right ahead and it will intersect with Houston Street on the left. Take the pathway on the left right before Houston Street.")
print("Continue down the pathway until you meet the James Earl Rudder statue. From there you will turn right.")
print("Continue until you reach Throckmorton Street, and then take a right.")
...
print ("To know if you are on the right path you should pass building such as the building of Mechanical Engineering and Harey R. Bright Building")
print ("Continue walking straight until you see the Anthropology Building where you will go a bit past it and take a right, down the path at the back")
print ("You will then take continue walking straight till you come across a path to your left between Glasscock Building and Sterling C.Evans Library")
...
print ("Walk straight down Coke Street past building such as the Sanders Corps of Cadets Centre, the Memorial bench.")
print ("Continue Walking till you reach the intersections and make your way to George Bush Dr")
print ("Walk down till you see the Association of Former students building and there you would should the Giant Aggie Ring")
